...
urlpatterns = [
    ...
    path('bulk-upload-alumni/', views.bulk_upload_alumni, name='bulk_upload_alumni'),
    # Add this for viewing individual alumni profile if not exists
    path('view/<int:id>/', lambda request, id: redirect('/alumni/'), name='view_alumni'),
]