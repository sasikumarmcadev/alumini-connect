...
# Prefer SQLite for local/dev if a local DB file exists or when USE_SQLITE=1 is set.
if os.environ.get("USE_SQLITE") == "1" or os.path.exists(os.path.join(BASE_DIR, "db.sqlite3")):
    DATABASES = {
        "default": {
